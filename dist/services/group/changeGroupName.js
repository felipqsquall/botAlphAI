...
export const changeGroupName = (client, groupId, groupNameChangeTime) => {
    ...
    schedule.scheduleJob({ hour: parseInt(changeHour), minute: parseInt(changeMinute), dayOfWeek: [new schedule.Range(1, 6)] }, changeName);
};
